...
let masterMenu: [Menu] = [Menu(restaurant: "McDorks", item: "Hamburger", price: 2.50, keywords: ["burger", "mcdorks"]),
                          Menu(restaurant: "McDorks", item: "Bacon Cheeseburger", price: 3.00, keywords: ["burger","cheese","cheeseburger", "bacon", "mcdorks"]),
                          Menu(restaurant: "McDorks", item: "French Fries", price: 1.99, keywords: ["fries", "side", "mcdorks"]),
                          ...
                          Menu(restaurant: "Out & In", item: "Classic Hamburger", price: 3.00, keywords: ["burger", "out & in"]),
                          Menu(restaurant: "Out & In", item: "Double Cheeseburger", price: 3.60, keywords: ["burger", "cheese", "cheeseburger", "out & in"]),
                          Menu(restaurant: "Out & In", item: "French Fries", price: 2.50, keywords: ["fries", "side", "out & in"]),
                          ...
                          Menu(restaurant: "Wendels", item: "Double Cheeseburger", price: 4.99, keywords: ["cheeseburger", "burger", "cheese","wendels"]),
